...
Meine Version mit einigen Aenderungen fur Glasscocktit Applikation

for Uploade use Board: Arduino nano w/ATmega328, Programmer: AVRISP mkJI
...
///static int16_t  Compass_Heading;                  // [0 .. 360 deg]
...
// **********************
  ...
  //static int32_t Baro_P_mbara;
  static int32_t baroTemperature;
  //static int32_t Baro_T_gradC;
