...
/************************  boards and sensor definitions  ***************************/
      ...
      #define CRIUS_AIO_PRO_V2  // Crius AIO Pro 2.0 MPU6050 + HMC5883L + MS561101BA
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    #define MMGYROVECTORLENGTH 10          // Length of Moving Average Vector (maximum value for tunable MMGYRO (orig:15)
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    //#define GPS_BAUD   115200 //Ist zu nehmen
   ...
   /* GPS protocol 
    ...
    #define GPS_LED_INDICATOR  //Ist zu nehmen
    ...
    #define MAG_DECLINIATION  2.5f              //For Munich Germany.
